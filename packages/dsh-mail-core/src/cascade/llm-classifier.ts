...
export const SYSTEM_PROMPT = [
  ...
  '',
  // Measured, not guessed: on a real inbox the same sender came back under
  // four different categories across seven messages, and every frequent source
  ...
  '3. Is it a machine telling the owner about state? -> newsletter-notification.',
  '   Build results, service status, account activity, calendar invitations,',
  ...
  '- Keep vs. know: a receipt is transactional because it is worth keeping; a',
  '  status update is newsletter-notification because it is only worth knowing.',
  '',
